...
function showCategory(category) {
    let newProducts = products[category];

    for (let i = 0; i<newProducts.length; i++) {
        productsDiv.innerHTML += getProductMarkup(newProducts[i]);
        console.log(getProductMarkup(newProducts[i]));
    }
...
function getProductMarkup(product) {
    ...
    let productText = `<div class="product"><div>${product.name}</div>
